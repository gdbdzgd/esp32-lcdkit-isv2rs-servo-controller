...
typedef struct app_layer {
    ...
    struct app_layer *lv_show_layer;
...
extern void lv_create_home(app_layer_t *home_layer);

extern void enter_clock_time();

extern void feed_clock_time();

extern void lv_create_clock(app_layer_t *clock_layer, uint32_t tmOut);

extern void lv_func_goto_layer(app_layer_t *dst_layer);
